      ...
      <div class="container-fluid ">
        <a class="navbar-brand" href="index.html"><img id="logo" src="/images/logo.png"> &nbsp;&nbsp;&nbsp;Cosmic Cafe</a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <ul class="cart navbar-nav ms-auto mb-2 mb-lg-0">
                  <li class="nav-item dropdown">
                    <a class="nav-link" href="login.html" id="user">Login</a>
                  </li>
    ...
    <div class="intro container mt-5">
      ...
      <div class="row justify-content-center mt-5">
        <div class="col-8 col-sm-6 col-md-4 col-lg-4 col-xl-4 info-1 ">
          <img src="images/coffee-shop.jpeg" alt="" width="100%">
          <div class="res-info">
            <h5><a class="primary-color-1" href="contactUs.html">Coffee Shop</a></h5>
          </div>
        </div>
        <div class="col-8 col-sm-6 col-md-4 col-lg-4 col-xl-4 info-2">
          <img src="images/menu2.jpeg" alt="" width="100%">
          <div class="res-info">
            <h5><a class="primary-color-1"href="menu.html">Menu</a></h5>
          </div>
        </div>
        <div class="col-8 col-sm-6 col-md-4 col-lg-4 col-xl-4 info-3">
          <img src="images/about.jpeg" alt="" width="100%">
          <div class="res-info">
            <h5><a class="primary-color-1" href="aboutUs.html">About Us</a></h5>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="partners container-fluid my-5">
      ...
      <div class="container">
        <div class="row justify-content-between brands pb-5">
          <img src="images/starbucks.png" alt="cocacola logo">
          <img src="images/costa.png" alt="dipitt logo">
          <img src="images/second-cup.png" alt="k&ns logo">
          <img src="images/dunkin-donuts.png" alt="foodpanda logo">
        </div>
      </div>
    </div>
