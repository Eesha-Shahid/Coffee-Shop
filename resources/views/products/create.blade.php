...
@section('content')
    ...
    <div class="container-fluid dashboard-color pl-5">    
        ...
        <div class="d-sm-flex mb-4">
            ...
            <h1 class="primary-color-1 font-weight-bold mb-4">Add Product</h1>
        </div>
        ...
        <div class="card col-12 border-left-primary">
            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group first d-flex flex-column pt-5 pl-4">
                    ...
                    <input name="image" type="file" class="email" id="picture" onchange="pdtImageVal()">
                    <small class="text-danger mt-2 pl-2" id="pictureError" style="display: none;"></small>
                </div>

                <!-- Name -->
                <div class="form-group last mb-3 d-flex flex-column pl-4">
                    <label class="primary-color-2" for="password">Product Name</label>
                    <input name="name" type="text" class="email" id="pdtName" onfocusout="pdtNameVal()">
                    <small class="text-danger mt-2 pl-2" id="pdtNameError" style="display: none;"></small>
                </div>
                ...
                <div class="form-group last mb-3 d-flex flex-column pl-4">
                    ...
                    <small class="text-danger mt-2 pl-2" id="catError" style="display: none;"></small>
                </div>

                <!-- Price -->
                <div class="form-group last mb-3 d-flex flex-column pl-4">
                    <label class="primary-color-2" for="password">Product Price</label>
                    <input name="price" type="text" class="email" id="pdtPrice" onfocusout="priceVal()">
                    <small class="text-danger mt-2 pl-2" id="priceError" style="display: none;"></small>
                </div>
                <button type="submit" class="email-button mt-3 mb-5">Add Product</button>
            </form>
        </div>
    </div>
